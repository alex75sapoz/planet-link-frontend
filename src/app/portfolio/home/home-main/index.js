                ...
                <Row className='pb-3'>
                    <Col>
                        <div className='d-flex justify-content-center'>
                            <a href='https://www.linkedin.com/in/alex-sapozhnikov-7449081b8' rel='noopener noreferrer' target='_blank' className={cn(style.imageContainer, style.imageHover, 'me-3')}>
                                <img src={Asset.technology.linkedin} style={{ padding: '5px' }} height={40} alt='' />
                                <p>LinkedIn</p>
                            </a>
                            <a href='https://github.com/SovietAlex' rel='noopener noreferrer' target='_blank' className={cn(style.imageContainer, style.imageHover, 'ms-3')}>
